...
public class secondevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondevent);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(secondevent.this, booking.class);
    ...
    public void AddEvent(){
        Conf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haha==true){
                    Toast.makeText(secondevent.this,"Event added!", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(secondevent.this,"Event already exists", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
