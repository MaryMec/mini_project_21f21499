...
public class fourevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourevent);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(fourevent.this, booking.class);
    ...
    public void AddEvent(){
        Conf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haha==true){
                    Toast.makeText(fourevent.this,"Event added!", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(fourevent.this,"Event already exists", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
