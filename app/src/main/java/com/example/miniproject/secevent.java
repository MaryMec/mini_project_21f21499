...
public class secevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secevent);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(secevent.this, booking.class);
    ...
    public void AddEvent(){
        Conf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haha==true){
                    Toast.makeText(secevent.this,"Event added!", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(secevent.this,"Event already exists", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
