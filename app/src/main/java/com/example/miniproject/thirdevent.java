...
public class thirdevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thirdevent);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(thirdevent.this, booking.class);
    ...
    public void AddEvent(){
        Conf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (haha==true){
                    Toast.makeText(thirdevent.this,"Event added!", Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(thirdevent.this,"Event already exists", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
